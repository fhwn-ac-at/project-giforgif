...
## Lobby-System
![LobbySystem](LobbySystem.png)

## Auktion
![Auction](Auction.png)

## Häuser bauen
![Build Houses](BuildHouses.png)

## Unbebautes Grundstück kaufen
![Buying Unowned Property](BuyingUnownedProperty.png)

## Gefängnis
![Jail](Jail.png)

## Spieler hat gewonnen
![Player Won](PlayerWon.png)

## Würfeln
![Roll Dice](RollDice.png)

## Erfolgreiche Transaktion
![Successful Transaction](SucessfulTransaction.png)

## Währungsübertragung im Schuldenmodus
![Transfer Currency Debt Mode](TransferCurrencyDebtMode.png)
