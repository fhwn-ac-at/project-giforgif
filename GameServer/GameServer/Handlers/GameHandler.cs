	...
	public class GameHandler
	{
        ...
        public async Task HandleSellHousePacket(Packet packet, HubCallerContext context)
        {
            ...
            if (sellValue != 0)
			{
                ...
                await _lobbyContext.Clients.Group(GetRoomName(context)).SendAsync("ReceivePacket", JsonSerializer.Serialize(new HouseSoldPacket() { FieldId = field.Id }));
        ...
        public async Task HandleSellPropertyPacket(Packet packet, HubCallerContext context)
        {
            ...
            if (sellValue != 0)
			{
                ...
                await _lobbyContext.Clients.Group(GetRoomName(context)).SendAsync("ReceivePacket", JsonSerializer.Serialize(new PropertySoldPacket() { FieldId = field.Id }));
